========================================================================
    APLICACIÓN DE CONSOLA: Zombie Bomber 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Zombie Bomber.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Zombie Bomber.


Zombie Bomber.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Zombie Bomber.pch y un archivo de tipos 
